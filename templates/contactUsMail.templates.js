const contactUsMail = (name, email, message) => {
  return `
            	...
            	<tr>
            		...
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: left;">
							...
							<h4><b>${name}</b> tried to contact you and left a message, here are the details;
							<br/>
							 <h4>"${message}"</h4>
							<br/>
							<h5>You can reach out to them via their email: ${email}.</h5>
            			</div>
            		</td>
            	</tr>
            </table>
